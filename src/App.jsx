...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <div className="sticky top-0 z-50 border-b border-slate-300 bg-white px-3 py-2 shadow-sm print:hidden">
        <div className="mx-auto flex max-w-[1360px] flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-slate-500">Los Neto</p>
            <h1 className="text-base font-semibold tracking-tight text-slate-950">Painel gerencial</h1>
          </div>

          <div className="flex flex-wrap items-center gap-2">
            <div className="grid grid-cols-2 rounded-[8px] border border-slate-300 bg-slate-100 p-0.5">
              {modes.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      active ? "bg-slate-900 text-white shadow-sm" : "text-slate-600 hover:bg-white hover:text-slate-950",
                    ].join(" ")}
                    aria-pressed={active}
                  >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-[6px] border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50"
            >
